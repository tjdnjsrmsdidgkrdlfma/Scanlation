...
from compare.core import (
    OCR_PROMPT, _PALETTE, Box, DetResult, Adapter, _imports_ok, _hf_weight_file,
    _torch_device, _resolve_device, dedup_boxes,
)


from compare.adapters import (
    UltralyticsDetAdapter, TransformersDetAdapter, MangaOcrAdapter,
    OllamaVlmAdapter, HfVlmAdapter, HfCausalVlmAdapter, MitOcrAdapter,
)

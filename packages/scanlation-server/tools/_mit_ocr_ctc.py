"""Vendored OCR models (48px CTC) from zyddnys/manga-image-translator (GPL). Pure torch;
the OfflineOCR download/Quadrilateral wrapper is intentionally NOT vendored — see tools/_mit_ocr.py."""
import math
